...
![Redshift to ClickHouse Migration Options](./redshift-to-clickhouse.png)
...
![PUSH Redshift to ClickHouse](./push.png)
...
![PULL from Redshift to ClickHouse](./pull.png)
...
![PIVOT from Redshift using S3](./pivot.png)
...
1. Using Redshift's [UNLOAD](https://docs.aws.amazon.com/redshift/latest/dg/r_UNLOAD.html) feature, export the data into a an existing private S3 bucket:
    ...
    ![UNLOAD from Redshift to S3](./s3-1.png)
